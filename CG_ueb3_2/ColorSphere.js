 ...
 */
function drawSphere(gl, sphere, color, shaderProgramm, modelMatrix, viewMatrix, projectionMatrix) {
    "use strict";
    ...
    gl.vertexAttrib3f(shaderProgramm.aColorId, color[0], color[1], color[2]);
